"""Atlas Artifacts page — real Qt page using the ArtifactController controller.
...
if _HAS_QT:
    ...
    class ArtifactsPage(QtWidgets.QWidget):  # type: ignore[misc, valid-type]
        """Real Artifacts page.

        Parameters:
            controller: :class:`ArtifactController` instance.
            parent: Optional Qt parent.
        """

        def __init__(self, controller: ArtifactController, parent: Any = None) -> None:
            super().__init__(parent)
            self.setObjectName("AtlasArtifactsPage")
        ...
        def _build_ui(self) -> None:
            ...
            title = QtWidgets.QLabel("Artifacts")
        ...
        def _fetch_items(self, query: str) -> list[Any]:
            list_method = getattr(self.controller, "artifacts", None)
    ...
    class ArtifactsPage:  # type: ignore[no-redef]
