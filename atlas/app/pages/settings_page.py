"""Atlas Settings page — real Qt info page.
...
if _HAS_QT:
    ...
    class SettingsPage(QtWidgets.QWidget):  # type: ignore[misc, valid-type]
        """Real Settings page."""

        def __init__(self, parent: Any = None) -> None:
            super().__init__(parent)
            self.setObjectName("AtlasSettingsPage")
            self._build_ui()
        ...
        def _build_ui(self) -> None:
            ...
            self.status_label = QtWidgets.QLabel("Configure Atlas")
    ...
    class SettingsPage:  # type: ignore[no-redef]
