"""Atlas Providers page — real Qt page using the ProviderController controller.
...
if _HAS_QT:
    ...
    class ProvidersPage(QtWidgets.QWidget):  # type: ignore[misc, valid-type]
        """Real Providers page.

        Parameters:
            controller: :class:`ProviderController` instance.
            parent: Optional Qt parent.
        """

        def __init__(self, controller: ProviderController, parent: Any = None) -> None:
            super().__init__(parent)
            self.setObjectName("AtlasProvidersPage")
        ...
        def _build_ui(self) -> None:
            ...
            title = QtWidgets.QLabel("Providers")
        ...
        def _fetch_items(self, query: str) -> list[Any]:
            list_method = getattr(self.controller, "providers", None)
    ...
    class ProvidersPage:  # type: ignore[no-redef]
