"""Atlas Logs page — real Qt info page.
...
if _HAS_QT:
    ...
    class LogsPage(QtWidgets.QWidget):  # type: ignore[misc, valid-type]
        """Real Logs page."""

        def __init__(self, parent: Any = None) -> None:
            super().__init__(parent)
            self.setObjectName("AtlasLogsPage")
            self._build_ui()
        ...
        def _build_ui(self) -> None:
            ...
            self.status_label = QtWidgets.QLabel("View application logs")
    ...
    class LogsPage:  # type: ignore[no-redef]
