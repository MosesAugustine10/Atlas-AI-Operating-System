"""Atlas System page — real Qt page using the SystemController controller.
...
if _HAS_QT:
    ...
    class SystemPage(QtWidgets.QWidget):  # type: ignore[misc, valid-type]
        """Real System page.

        Parameters:
            controller: :class:`SystemController` instance.
            parent: Optional Qt parent.
        """

        def __init__(self, controller: SystemController, parent: Any = None) -> None:
            super().__init__(parent)
            self.setObjectName("AtlasSystemPage")
        ...
        def _fetch_items(self, query: str) -> list[Any]:
            list_method = getattr(self.controller, "stats", None)
        ...
        def _item_label(item: Any) -> str:
            ...
            return str(getattr(item, "key", item))

else:

    class SystemPage:  # type: ignore[no-redef]
