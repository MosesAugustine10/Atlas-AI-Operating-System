"""Atlas MCP page — real Qt page using the MCPController controller.
...
if _HAS_QT:
    ...
    class MCPPage(QtWidgets.QWidget):  # type: ignore[misc, valid-type]
        """Real MCP page.

        Parameters:
            controller: :class:`MCPController` instance.
            parent: Optional Qt parent.
        """

        def __init__(self, controller: MCPController, parent: Any = None) -> None:
            super().__init__(parent)
            self.setObjectName("AtlasMCPPage")
        ...
        def _fetch_items(self, query: str) -> list[Any]:
            list_method = getattr(self.controller, "connectors", None)
    ...
    class MCPPage:  # type: ignore[no-redef]
