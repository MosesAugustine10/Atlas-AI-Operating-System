"""Atlas Agents page — real Qt page using the AgentController controller.

View and manage Atlas agents.
"""
...
if _HAS_QT:
    ...
    class AgentsPage(QtWidgets.QWidget):  # type: ignore[misc, valid-type]
        """Real Agents page.

        Parameters:
            controller: :class:`AgentController` instance.
            parent: Optional Qt parent.
        """

        def __init__(self, controller: AgentController, parent: Any = None) -> None:
            super().__init__(parent)
            self.setObjectName("AtlasAgentsPage")
        ...
        def _fetch_items(self, query: str) -> list[Any]:
            list_method = getattr(self.controller, "agents", None)
    ...
    class AgentsPage:  # type: ignore[no-redef]
